...
<style>
  ...
  .locate-btn:active { transform: translateX(-50%) scale(0.98); }

  /* fab */
  .fab-container { position: fixed; bottom: 20px; right: 20px; z-index: 20; }
  .fab-button {
    background-color: #634360; color: #fff; width: 50px; height: 50px;
...
<!-- parent-level locate button (required for iOS/strict mobile) -->
<div class="locate-wrap">
  <button class="locate-btn" onclick="parentLocate()">📍 Use my location</button>
</div>
